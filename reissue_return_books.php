...
<html lang="en">
    <head>
        ...
        <title>Library Management system | Reissue/Return Books</title>
    ...
    <body>
        ...
        <?php 
            ...
            <div class="container-fluid">
                <div class="form-group input-group rrbks">
                    <p>
                        <input type="number" id="user_id" class="form-control rrbks">
                    </p>
                </div>
                <div class="form-group input-group">
                    <p>
                        <button class="form-control btn btn-primary custom-btn rrbks" id="btn_search_books" onclick="
        ...
        <div class="table-content">
            <div class="container-fluid">
                <form name="form_issue" method="POST" action="<?= $_SERVER['PHP_SELF']?>"
                    ...
                    <div class="form-group input-group">
                        <p>
                            <input type="submit" value="Submit" class="form-control btn btn-primary custom-btn rrbks">
                        </p>
                    </div>
                </form>
            </div>
